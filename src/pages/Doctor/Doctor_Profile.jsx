...
const Doctor_Profile = () => {
    ...
    const getDoctor=()=>{
        fetch("http://127.0.0.1:8000/api/doctor/api/doctors/").then(
            res =>{
                if(res.ok){
                    return res.json()
                }else {
        ...
        <div className="flex flex-col font-semibold max-md:mt-10">
          <div className="flex flex-col p-6 w-full bg-white rounded-2xl shadow-md max-md:px-5">
            ...
            <div className="flex gap-2 justify-between mt-6 text-sm leading-4 whitespace-nowrap text-zinc-800">
              ...
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/37aa280ccb6ee2101f0f120e09c13b5b8f4d7697ca33478abda16b45742fdd5e?"
                className="my-auto max-w-full aspect-[1.02] w-[117px]"
              />
            </div>
          </div>
