  ...
  return (
    <div>
            ...
            <div className="w-[1110px] relative bg-theme-white-default shrink-0">
              <div className="absolute top-[0px] left-[0px] w-[1110px] flex flex-col items-start justify-start">
                <div className="self-stretch relative h-[60px] overflow-hidden shrink-0">
                  ...
                  <button className="absolute top-[11px] left-[937px] rounded-md bg-theme-primary-dark w-[156px] flex flex-col items-start justify-start py-2.5 px-5  h-10 box-border text-theme-white-default" onClick={handle}>
                  ...
                  <button className="absolute top-[11px] left-[765px] rounded-md  h-10 bg-theme-white-default box-border w-[156px] flex flex-col items-start justify-start py-2.5 px-5 text-theme-primary-dark border-[1px] border-solid border-theme-primary-dark" onClick={() => generatePDF(targetRef, {filename: 'Dishcharged_Patient_List.pdf'})} >
      ...
      <TableCell>Action</TableCell>
                      ...
                      <TableBody>
  {myData.slice(page * rowperpage, page * rowperpage + rowperpage).map((user) => (
    <TableRow key={user.visit_id}>
    <TableCell>{user.visit_id}</TableCell>
    <TableCell>{user.visit_date} </TableCell>
    <TableCell>{user.ddepartment}</TableCell>
    <TableCell>{user.patient_id}</TableCell>
    <TableCell>{user.doctor_id}</TableCell>
